...
public abstract class CopperRod extends DirectionalBlock {
    ...
    protected CopperRod(BlockBehaviour.Properties p_154339_) {
        super(p_154339_);
    }

    @Override
    protected abstract MapCodec<? extends net.minecraft.world.level.block.RodBlock> codec();
